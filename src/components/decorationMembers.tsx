...
import DecorationMembers from "../data/decorationMembers";

// Define props type
type DecorationMembersType = {
  img: string;
  name: string;
};

const DecorationMemberCard: React.FC<{ member: DecorationMembersType }> = ({ member }) => {
  return (
...
export default DecorationMemberList;