...
import EventMembers from "../data/eventMembers";
import { ContentwriterLead as EventMemberType } from "../types";


const EventMemberCard: React.FC<{ member: EventMemberType }> = ({ member }) => {
  return (
...
const EventMemberList: React.FC = () => {
  return (
